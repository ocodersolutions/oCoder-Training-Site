...
function create_post_type_html5()
{
    ...
    register_post_type('html5-blank', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'add_new_item' => __(' HTML5 Blank Custom Post', 'html5blank'),
...
// creat nav menu support for theme

//kiem tra funtions nay co hay ko
...
function new_excrept_more($more)
{
    global $post;
